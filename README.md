...
- **Klassische Rennmodi**:
  ...
  - Integrierte Vollbild-Qualifikation mit Zufallsgenerator (`🎲 Würfeln`), Einzel-Quali und automatischer Gruppenoptimierung.

---

## Zusatzfunktionen gegenüber WinRBM

OpenRBM übernimmt nicht nur alle WinRBM-Funktionen, sondern erweitert sie um moderne Features für Vereins- und Langstreckenrennen:

### 1. Team- & Langstreckenrennen (Team-Modus)
- **Mehrfahrer-Teams**: Teams mit 2 bis 6 Fahrern und zugewiesenem Team-Fahrzeug.
...
- **Stint-Zeiterfassung**: Präzise Messung der tatsächlichen Fahrzeit je Fahrer.
