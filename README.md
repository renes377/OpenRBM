...
- **100% Feature-Parität zu WinRBM 1.32**:
  - Bis zu 8 Spuren, Zeitmessung mit ms-genauen Hardware-Zeitstempeln.
  - Direkte serielle Steuerung der Bepfe-Elektronik über die native Browser **Web Serial API**.
  - Fahrstrom-Relais-Steuerung und Ampelphasen (Rot/Gelb/Grün).
- **Rennmodi**:
  - Freies Training mit Rundenrekord-Ticker.
  - Einzelrennen (Runden- und Zeitmodus).
  - Serienrennen mit automatischen Spurwechsel-Algorithmen und Gruppenrotation.
  - Integrierte Qualifikation (Einzel-Quali & 1-Klick-Übernahme in die Startaufstellung).
- **Moderne Benutzeroberfläche**:
  - Authentische Bepfe-Spurfarben oder frei wählbare Farben.
  - Integriertes Benutzerhandbuch (**F1**).
  - 100% Offline-Betrieb (PWA-installierbar).
  - Alle Daten (Fahrer, Fahrzeuge, Bahnen, Rekorde) werden lokal auf dem Rechner in der Browser-Datenbank (IndexedDB) gespeichert.
